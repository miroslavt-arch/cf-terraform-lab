#!/usr/bin/env python3
"""Normalize `terraform plan -generate-config-out` output.
...
Usage: python normalize.py generated.tf

ADAPTING THIS: DROP_LINE_PATTERNS below is the whole configuration. Add
patterns for attributes your provider echoes back but you never want to
manage. Run it, read the diff, iterate - it is meant to be tuned per provider.
"""
